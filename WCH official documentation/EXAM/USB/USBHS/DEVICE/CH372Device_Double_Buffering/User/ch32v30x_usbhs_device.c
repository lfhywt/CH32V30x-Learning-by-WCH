...
__attribute__ ((aligned(4))) uint8_t USBHS_EP1_Rx_Buf0[ DEF_USB_EP1_HS_SIZE ];
__attribute__ ((aligned(4))) uint8_t USBHS_EP1_Rx_Buf1[ DEF_USB_EP1_HS_SIZE ];
__attribute__ ((aligned(4))) uint8_t USBHS_EP2_Tx_Buf0[ DEF_USB_EP2_HS_SIZE ];
__attribute__ ((aligned(4))) uint8_t USBHS_EP2_Tx_Buf1[ DEF_USB_EP2_HS_SIZE ];
__attribute__ ((aligned(4))) uint8_t USBHS_EP3_Rx_Buf0[ DEF_USB_EP3_HS_SIZE ];
__attribute__ ((aligned(4))) uint8_t USBHS_EP3_Rx_Buf1[ DEF_USB_EP3_HS_SIZE ];
__attribute__ ((aligned(4))) uint8_t USBHS_EP4_Tx_Buf0[ DEF_USB_EP4_HS_SIZE ];
__attribute__ ((aligned(4))) uint8_t USBHS_EP4_Tx_Buf1[ DEF_USB_EP4_HS_SIZE ];
...
void USBHS_Device_Endp_Init ( void )
{
    ...
    USBHSD->BUF_MODE  = USBHS_UEP1_BUF_MOD | USBHS_UEP2_BUF_MOD | USBHS_UEP3_BUF_MOD | USBHS_UEP4_BUF_MOD;

    for (uint32_t i = 0; i < sizeof(USBHS_EP6_Tx_Buf); i++)
    {
        USBHS_EP6_Tx_Buf[i] = i;
    }
            ...
            case USBHS_UIS_TOKEN_IN:
                switch ( intst & ( USBHS_UIS_TOKEN_MASK | USBHS_UIS_ENDP_MASK ) )
                {
                    ...
                    case USBHS_UIS_TOKEN_IN | DEF_UEP2:
                        ...
                        if (USBHSD->UEP2_TX_CTRL & USBHS_UEP_T_TOG_DATA1)
                        {   /* DATA0 */
                    ...
                    case USBHS_UIS_TOKEN_IN | DEF_UEP4:
                        ...
                        if (USBHSD->UEP4_TX_CTRL & USBHS_UEP_T_TOG_DATA1)
                        {   /* DATA0 */
                        ...
                        else
                        {
                            ...
                            USBHSD->UEP3_RX_CTRL = (USBHSD->UEP3_RX_CTRL & ~USBHS_UEP_R_RES_MASK) | USBHS_UEP_T_RES_ACK;
                        }
                        break;
                ...
                switch( intst & ( USBHS_UIS_TOKEN_MASK | USBHS_UIS_ENDP_MASK ) )
                {
                    ...
                    case USBHS_UIS_TOKEN_OUT | DEF_UEP1:
                        if ( intst & USBHS_UIS_TOG_OK )
                        {
                            ...
                            if (USBHSD->UEP1_RX_CTRL & USBHS_UEP_R_TOG_DATA1)
                            {   // DATA0
                                USBHS_Endp_Busy[DEF_UEP2] |= 0x01;
                                for (i = 0; i < len; i++)
                                {
                    ...
                    case USBHS_UIS_TOKEN_OUT | DEF_UEP3:
                        if ( intst & USBHS_UIS_TOG_OK )
                        {
                            ...
                            if (USBHSD->UEP3_RX_CTRL & USBHS_UEP_R_TOG_DATA1)
                            {   // DATA0
                                USBHS_Endp_Busy[DEF_UEP4] |= 0x01;
                                for (i = 0; i < len; i++)
                                {
                                    USBHS_EP4_Tx_Buf0[i] = ~USBHS_EP3_Rx_Buf0[i];
                                }
                            }
                            else
                            {   // DATA1
                                ...
                                for (i = 0; i < len; i++)
                                {
                                    USBHS_EP4_Tx_Buf1[i] = ~USBHS_EP3_Rx_Buf1[i];
                                }
                            }
