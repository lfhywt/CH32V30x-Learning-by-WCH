...
extern __attribute__ ((aligned(4))) uint8_t USBHS_EP1_Rx_Buf0[ DEF_USB_EP1_HS_SIZE ];
extern __attribute__ ((aligned(4))) uint8_t USBHS_EP1_Rx_Buf1[ DEF_USB_EP1_HS_SIZE ];
extern __attribute__ ((aligned(4))) uint8_t USBHS_EP2_Tx_Buf0[ DEF_USB_EP2_HS_SIZE ];
extern __attribute__ ((aligned(4))) uint8_t USBHS_EP2_Tx_Buf1[ DEF_USB_EP2_HS_SIZE ];
extern __attribute__ ((aligned(4))) uint8_t USBHS_EP3_Rx_Buf0[ DEF_USB_EP3_HS_SIZE ];
extern __attribute__ ((aligned(4))) uint8_t USBHS_EP3_Rx_Buf1[ DEF_USB_EP3_HS_SIZE ];
extern __attribute__ ((aligned(4))) uint8_t USBHS_EP4_Tx_Buf0[ DEF_USB_EP4_HS_SIZE ];
extern __attribute__ ((aligned(4))) uint8_t USBHS_EP4_Tx_Buf1[ DEF_USB_EP4_HS_SIZE ];
extern __attribute__ ((aligned(4))) uint8_t USBHS_EP5_Rx_Buf[ DEF_USB_EP5_HS_SIZE ];
