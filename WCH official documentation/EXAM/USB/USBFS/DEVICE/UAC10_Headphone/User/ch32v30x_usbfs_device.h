...
#define DEF_RING_BUFFER_PACK_SIZE     (DEF_USBD_FS_ISO_PACK_SIZE + DEF_TRANSPORT_HEADER_SIZE)
#define DEF_RING_BUFFER_SIZE          (DEF_RING_BUFFER_MAX_BLKS * DEF_RING_BUFFER_PACK_SIZE)
